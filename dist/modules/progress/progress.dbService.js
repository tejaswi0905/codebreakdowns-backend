 ...
 */
export const upsertHeartbeatDb = async (userId, lessonId, currentTime) => {
 ...
 */
export const getLessonWithProgressDb = async (userId, lessonId) => {
...
export const updateLessonCompletionDb = async (userId, lessonId, isCompleted) => {
    return await prisma.lessonProgress.upsert({
        where: { userId_lessonId: { userId, lessonId } },
        update: { isCompleted },
        create: {
 ...
 */
export const evaluateChapterWaterfallDb = async (userId, chapterId, courseId) => {
...
export const toggleBookmarkDb = async (userId, lessonId, isBookmarked) => {
    return await prisma.lessonProgress.upsert({
        where: { userId_lessonId: { userId, lessonId } },
        update: { isBookmarked },
        create: {
 ...
 */
export const getStudentDashboardStatsDb = async (userId) => {
    const [accessStats, completedCount, bookmarkedCount, lastAccessedLesson] = await Promise.all([
...
//# sourceMappingURL=progress.dbService.js.map