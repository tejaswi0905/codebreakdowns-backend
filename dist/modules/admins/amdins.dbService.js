...
export const handleGoogleAdminDb = async (googleProfile, accessToken) => {
    ...
    if (existingAccount) {
        ...
        if (existingAccount.user.role !== "ADMIN") {
            throw new ForbiddenError("Access Denied: This account is registered as a Student, not an Admin.");
        }
    ...
    if (existingUser) {
        ...
        if (existingUser.role !== "ADMIN") {
            throw new ForbiddenError("Access Denied: This email address belongs to a Student account.");
        }
...
//# sourceMappingURL=amdins.dbService.js.map