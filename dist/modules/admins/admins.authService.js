...
import { getGoogleAuthTokens, getGoogleUserInfo, } from "../../shared/utils/googleOauth.js";
...
export const processGoogleLogin = async (code) => {
    ...
    const isVerified = googleProfile.verified_email || googleProfile.email_verified;
    if (!isVerified) {
        throw new BadRequestError("Your Google email address must be verified to access the Admin portal.");
    }
...
//# sourceMappingURL=admins.authService.js.map