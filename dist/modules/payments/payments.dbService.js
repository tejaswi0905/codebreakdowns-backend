...
export const checkUserOwnsProductDb = async (userId, productId) => {
...
export const getProductPriceDb = async (productId) => {
...
export const grantProductAccessDb = async (userId, productId, transactionId) => {
...
//# sourceMappingURL=payments.dbService.js.map